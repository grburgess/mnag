...
class pl4break(lcModel):


    def __init__(self):


        def pl(x, logA, i1, i2, i3,i4, i5 ,b1, b2, b3, b4):
...
#            x/=pivot
        ...
        self.paramsRanges = [[1.E-20,1.E-1,"J"],[-8.,2,"U"],[-8.,2,"U"],[-8.,2,"U"],[-8.,2,"U"],[-8.,2,"U"],[1E1,1E7,"J"],[1E1,1E7,"J"],[1E1,1E7,"J"],[1E1,1E7,"J"]]
        ...
        self.plOrder = 4
        self.modName = "pl4break"
        self.model=pl
        self.prior=plPrior
        self.n_params = 10
        self.parameters = ["log(N)","i1","i2","i3","i4","i5","b1","b2","b3","b4"]
